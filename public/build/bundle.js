...
var app = (function () {
    ...
    const file$6 = "src/components/smarts/Map.albers.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$6, 79, 2, 2431);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g, file$6, 74, 0, 2333);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
     ...
     */
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<Map_albers> was created with unknown prop '${key}'`);
    	});
    ...
    */
    ...
    const file$7 = "src/components/smarts/MapLabels.albers.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(text_1, "class", text_1_class_value = "label-text label-text-" + /*collection_name*/ ctx[0] + " svelte-1cx5wrs");
    			...
    			add_location(text_1, file$7, 77, 12, 2479);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*collection_name*/ 1 && text_1_class_value !== (text_1_class_value = "label-text label-text-" + /*collection_name*/ ctx[0] + " svelte-1cx5wrs")) {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$7, 67, 2, 2103);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, path, anchor);
    			if (if_block) if_block.m(target, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(g, "class", "map-group");
    			add_location(g, file$7, 61, 0, 1996);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<MapLabels_albers> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			p1 = element("p");
    			t6 = text("Data as of March 25, 2021 | Source: Centers for Disease Control and Prevention | Get the ");
    			a = element("a");
    			a.textContent = "data";
    			t8 = text(" | By John Keefe");
    			attr_dev(h1, "class", "svelte-14igrk9");
    			add_location(h1, file$8, 19, 1, 658);
    			attr_dev(p0, "class", "g-leadin svelte-14igrk9");
    			add_location(p0, file$8, 21, 1, 706);
