...
var app = (function () {
    ...
    /* src/components/smarts/Map.topojson.svelte generated by Svelte v3.32.2 */

    const { console: console_1$2 } = globals;
    const file$6 = "src/components/smarts/Map.topojson.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	function mouseover_handler(...args) {
    		return /*mouseover_handler*/ ctx[20](/*feature*/ ctx[25], ...args);
    	}

    	const block = {
    		c: function create() {
    			path = svg_element("path");
    			attr_dev(path, "class", "feature-path svelte-17bma4s");
    			attr_dev(path, "fill", path_fill_value = /*fill*/ ctx[0] || /*feature*/ ctx[25].properties.fill || "None" || /*$zGet*/ ctx[5](/*feature*/ ctx[25].properties));
    			attr_dev(path, "stroke", path_stroke_value = /*stroke*/ ctx[1] || /*feature*/ ctx[25].properties.stroke);
    			attr_dev(path, "stroke-width", path_stroke_width_value = /*strokeWidth*/ ctx[2] || /*feature*/ ctx[25].properties["stroke-width"]);
    			attr_dev(path, "d", path_d_value = /*geoPathFn*/ ctx[4](/*feature*/ ctx[25]));
    			add_location(path, file$6, 93, 2, 2834);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(
    						...
    						"mousemove",
    						function () {
    							if (is_function(/*handleMousemove*/ ctx[11](/*feature*/ ctx[25]))) /*handleMousemove*/ ctx[11](/*feature*/ ctx[25]).apply(this, arguments);
    						},
    						false,
    						false,
    						false
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*fill, features, $zGet*/ 41 && path_fill_value !== (path_fill_value = /*fill*/ ctx[0] || /*feature*/ ctx[25].properties.fill || "None" || /*$zGet*/ ctx[5](/*feature*/ ctx[25].properties))) {
    				attr_dev(path, "fill", path_fill_value);
    			}

    			if (dirty & /*stroke, features*/ 10 && path_stroke_value !== (path_stroke_value = /*stroke*/ ctx[1] || /*feature*/ ctx[25].properties.stroke)) {
    				attr_dev(path, "stroke", path_stroke_value);
    			}

    			if (dirty & /*strokeWidth, features*/ 12 && path_stroke_width_value !== (path_stroke_width_value = /*strokeWidth*/ ctx[2] || /*feature*/ ctx[25].properties["stroke-width"])) {
    				attr_dev(path, "stroke-width", path_stroke_width_value);
    			}

    			if (dirty & /*geoPathFn, features*/ 24 && path_d_value !== (path_d_value = /*geoPathFn*/ ctx[4](/*feature*/ ctx[25]))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(93:1) {#each features as feature}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g, file$6, 88, 0, 2736);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(g, "mouseout", /*mouseout_handler*/ ctx[21], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let $zGet;
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Map_topojson", slots, []);
    	...
    	let { projection = undefined } = $$props;
    	let { already_albers = false } = $$props;
     ...
     */
    	...
    	if (already_albers) {
    		...
    		projection_base = geoIdentity().reflectY(true);
    	} else {
    		projection_base = projection(); // .fitSize([$width, $height], $data);
     ...
     */
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<Map_topojson> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("already_albers" in $$props) $$invalidate(13, already_albers = $$props.already_albers);
    		...
    		if ("collection_name" in $$props) $$invalidate(14, collection_name = $$props.collection_name);
    		if ("base_collection_name" in $$props) $$invalidate(15, base_collection_name = $$props.base_collection_name);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("base_collection" in $$props) $$invalidate(24, base_collection = $$props.base_collection);
    		if ("features" in $$props) $$invalidate(3, features = $$props.features);
    		if ("projection_base" in $$props) $$invalidate(16, projection_base = $$props.projection_base);
    		if ("projectionFn" in $$props) $$invalidate(17, projectionFn = $$props.projectionFn);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*projection_base, $width, $height*/ 851968) {
    			$$invalidate(17, projectionFn = projection_base.fitSize([$width, $height], base_collection));
    		}

    		if ($$self.$$.dirty & /*projectionFn*/ 131072) {
    ...
    class Map_topojson extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, {
    			...
    			strokeWidth: 2,
    			collection_name: 14,
    			base_collection_name: 15,
    			features: 3
    		});

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "Map_topojson",
    			options,
    			id: create_fragment$6.name
    		});
    	}
    	...
    	get projection() {
    		throw new Error("<Map_topojson>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set projection(value) {
    		throw new Error("<Map_topojson>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    // (33:6) <LayerCake         z='FOO'         data={theTopojson}        >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:6) <LayerCake         z='FOO'         data={theTopojson}        >",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-14igrk9");
    			add_location(h1, file$7, 19, 1, 619);
    			attr_dev(p0, "class", "g-leadin svelte-14igrk9");
    			add_location(p0, file$7, 21, 1, 667);
    			attr_dev(div, "class", "chart-container svelte-14igrk9");
    			set_style(div, "height", /*w*/ ctx[0] * height_from_width + "px ");
    			add_render_callback(() => /*div_elementresize_handler*/ ctx[1].call(div));
    			add_location(div, file$7, 31, 4, 1153);
    			attr_dev(a, "href", "https://covid.cdc.gov/covid-data-tracker/COVIDData/getAjaxData?id=vaccination_data");
    			add_location(a, file$7, 73, 112, 2218);
    			attr_dev(p1, "class", "g-notes svelte-14igrk9");
    			add_location(p1, file$7, 73, 4, 2110);
    			attr_dev(main, "class", "svelte-14igrk9");
    			add_location(main, file$7, 17, 0, 610);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
